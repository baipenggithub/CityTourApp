 ...
 * </pre>
 */
public class TravelAdapter extends BaseRecyclerAdapter<HomeVideoBean.ResultBean.ItemsBean, BaseRecyclerHolder> {
     ...
     * @param data
     */
    public TravelAdapter(int layoutResId, @Nullable List<HomeVideoBean.ResultBean.ItemsBean> data) {
    ...
    protected void convert(BaseRecyclerHolder helper, HomeVideoBean.ResultBean.ItemsBean item) {
        ...
        GlideUtils.loadRoundCircleRes(BaseApplication.getApplication(), item.getId(), helper.getView(R.id.iv_video_pic), 30);
    }
}

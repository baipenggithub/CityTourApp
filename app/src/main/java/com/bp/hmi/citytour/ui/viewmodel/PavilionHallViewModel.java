...
public class PavilionHallViewModel extends BaseViewModel {
    private static final String TAG = PavilionHallViewModel.class.getSimpleName();
     ...
     * @param application
     */
    public PavilionHallViewModel(@NonNull Application application) {
        super(application);
        initData();
    }
